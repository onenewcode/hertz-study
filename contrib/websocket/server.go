...
// 升级将 HTTP 服务器连接升级到 WebSocket 协议。
//responseHeader 包含在对客户端升级的响应中
//请求。使用 responseHeader 指定 Cookie （Set-Cookie） 和
//应用程序协商的子协议 （Sec-WebSocket-Protocol）。
//如果升级失败，则升级将回复客户端并显示 HTTP 错误响应。
